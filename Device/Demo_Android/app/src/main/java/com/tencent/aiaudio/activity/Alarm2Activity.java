 ...
 * 闹钟触发界面，闹钟场景不可恢复
 */
public class Alarm2Activity extends BaseActivity {
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            if (focusChange == XWeiAudioFocusManager.AUDIOFOCUS_GAIN || focusChange == XWeiAudioFocusManager.AUDIOFOCUS_GAIN_TRANSIENT) {
                ...
                if (isFirst) {
                    ...
                    || focusChange == XWeiAudioFocusManager.AUDIOFOCUS_LOSS_TRANSIENT
                    || focusChange == XWeiAudioFocusManager.AUDIOFOCUS_LOSS) {
                finish();
            }
        }
    };
    ...
    private void startPlayRing() {
        ...
        XWSDK.getInstance().setUserState(stateInfo);
    }
